...
public class RestaurantProfileResponse implements Serializable {
    ...
    public class RestaurantDetail implements Serializable {
        ...
        @Expose
        private String deliveryCitiesNames;
        ...
        public String getDeliveryCitiesIds() {
            return deliveryCitiesIds;
        }

        public void setDeliveryCitiesIds(String deliveryCitiesIds) {
            this.deliveryCitiesIds = deliveryCitiesIds;
        }

        public String getDeliveryCitiesNames() {
            return deliveryCitiesNames;
        }

        public void setDeliveryCitiesNames(String deliveryCitiesNames) {
            this.deliveryCitiesNames = deliveryCitiesNames;
        }
