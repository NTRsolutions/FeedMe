...
public class FloatingActionLinearLayoutBehavior extends CoordinatorLayout.Behavior<FloatingActionLinearLayout> {

    private Rect mTmpRect;
    private int adjustPadding;

    public FloatingActionLinearLayoutBehavior(int adjustPadding) {
        super();
        this.adjustPadding = adjustPadding;
    }

    @Override
    public boolean layoutDependsOn(CoordinatorLayout parent, FloatingActionLinearLayout child, View dependency) {
        // check that our dependency is the AppBarLayout
        return dependency instanceof ViewPager;
    }

    @Override
    public boolean onDependentViewChanged(CoordinatorLayout parent, FloatingActionLinearLayout child,
                                          View dependency) {
    ...
    private boolean updateCircleImageViewVisibility(CoordinatorLayout parent,
                                                    ViewPager appBarLayout, FloatingActionLinearLayout child) {
