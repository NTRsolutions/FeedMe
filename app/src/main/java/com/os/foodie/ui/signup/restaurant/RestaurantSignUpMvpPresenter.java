...
public interface RestaurantSignUpMvpPresenter<V extends RestaurantSignUpMvpView> extends MvpPresenter<V> {
    ...
    void onRestaurantSignUpClick(String fbId, String contactPersonName, String restaurantName, String email, String password, String confirm_password, String phone, String deviceId, String deviceType, String latitude, String longitude, String language, HashMap<String, File> fileMap);
